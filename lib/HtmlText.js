  ...
  render() {
    ...
    return (
      <View style={this.props.containerStyle}>
        ...
        {this.props.numberOfLines ? children.slice(0, this.props.numberOfLines) : children}
        {this.props.numberOfLines  && (children.length >= this.props.numberOfLines && <Text style={{fontSize: 30}}>...</Text>)}
